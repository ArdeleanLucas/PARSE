...
class ParseChatTools:
    ...
    def _tool_export_concept_appendix_md(self, args: Dict[str, Any]) -> Dict[str, Any]:
        return tool_export_concept_appendix_md(self, args)
    ...
    def _tool_revert_csv_reimport(self, args: Dict[str, Any]) -> Dict[str, Any]:
        return tool_revert_csv_reimport(self, args)
