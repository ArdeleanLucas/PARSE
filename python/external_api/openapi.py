...
def build_openapi_document(base_url: str = "http://127.0.0.1:8766") -> Dict[str, Any]:
    ...
    components = {
        "schemas": {
            ...
            "ConceptIdentityConcept": {"type": "object", "required": ["uid", "label", "members", "origin"], "properties": {"uid": {"type": "string"}, "label": {"type": "string"}, "members": {"type": "array", "items": {"type": "string"}}, "origin": {"type": "string"}}, "additionalProperties": False},
            "ConceptIdentityOverrideRequest": {"type": "object", "required": ["members", "origin"], "properties": {"uid": {"type": "string"}, "label": {"type": "string"}, "members": {"type": "array", "minItems": 1, "items": {"type": "string"}}, "origin": {"type": "string", "enum": ["manual:split", "manual:merge"]}}, "additionalProperties": False},
            "ConceptIdentityResponse": {"type": "object", "required": ["version", "concepts", "uid_by_row", "warnings"], "properties": {"version": {"type": "integer", "const": 1}, "concepts": {"type": "array", "items": _schema_ref("ConceptIdentityConcept")}, "uid_by_row": {"type": "object", "additionalProperties": {"type": "string"}}, "warnings": {"type": "array", "items": {"type": "string"}}}, "additionalProperties": False},
            "CompareCandidate": {"type": ["object", "null"], "properties": {"ipa": {"type": "string"}, "ortho": {"type": "string"}, "start_sec": {"type": "number"}, "end_sec": {"type": "number"}, "source_wav": {"type": "string"}, "realization_index": {"type": "integer", "minimum": 0}, "realizations": {"type": "array", "items": _schema_ref("CompareCandidate")}}, "additionalProperties": False},
            ...
            "CompareBundle": {
                "type": "object",
                "required": ["bundle_id", "uid", "label", "row_ids", "buckets", "candidates", "canonical", "warnings"],
                "properties": {
            ...
            "CompareBundlesResponse": {"type": "object", "required": ["bundles", "identity_warnings"], "properties": {"bundles": {"type": "array", "items": _schema_ref("CompareBundle")}, "identity_warnings": {"type": "array", "items": {"type": "string"}}}, "additionalProperties": False},
    ...
    paths: Dict[str, Any] = {
        ...
        "/api/concept-identity": {
            "get": {"tags": ["Compare"], "summary": "Read materialised concept identity grouping", "operationId": "getConceptIdentity", "responses": {"200": _response("Concept identity payload", _schema_ref("ConceptIdentityResponse"))}},
            "post": {"tags": ["Compare"], "summary": "Write a manual concept identity split or merge override", "operationId": "writeConceptIdentityOverride", "requestBody": {"required": True, "content": _json_content(_schema_ref("ConceptIdentityOverrideRequest"))}, "responses": {"200": _response("Updated materialised concept identity payload", _schema_ref("ConceptIdentityResponse")), "400": _response("Invalid override request", _schema_ref("ErrorResponse"))}},
        },
        "/api/compare/bundles": {
