...
def delete_concept_variant(
    ...
    *,
    ...
    A row that any speaker has annotated is protected: deletion raises 409 with
    the blocking speakers. Per-speaker recordings are removed through the
    annotation interval-delete endpoint, not here.
    """
