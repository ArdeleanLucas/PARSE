...
- Shipped MCP counts at that audit time: **55** `ParseChatTools`, **55** default MCP task tools, **59** default adapter tools. Supersession note: PR #206 later raised counts to **57** / **61**, and PR #257 later raised current counts to **58** `ParseChatTools`, **58** default MCP task tools, and **62** default/all adapter tools; legacy curated remains **38** parse-task tools / **42** adapter tools. See `docs/reports/2026-04-30-calendar-day-merged-pr-doc-refresh.md` and `docs/reports/2026-05-03-last-24h-published-pr-doc-refresh.md`.
