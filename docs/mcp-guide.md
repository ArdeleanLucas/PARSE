...
Use the curated default surface for most agent sessions. Switch to the full 58-tool surface only when you need the entire `ParseChatTools` registry exposed to the MCP client.
